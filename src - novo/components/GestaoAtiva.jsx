...
import { C, MN, FN, TN, PAL, heroStyle, premiumNoticeStyle, moneyCompactStyle } from "../lib/theme";
  ...
  {!isPremium && (
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 10, minWidth: 0, flex: 1 }}>
            <span style={{ fontSize: 9, fontWeight: 800, letterSpacing: "0.08em", color: C.red, border: `1px solid ${C.red}55`, borderRadius: 5, padding: "2px 6px", fontFamily: MN, flexShrink: 0 }}>LIMITADO</span>
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: C.white, lineHeight: 1.25 }}>Mais categorias, mais controle</div>
              <div style={{ fontSize: 11, color: C.textDim, lineHeight: 1.45, marginTop: 2 }}>Desbloqueie categorias ilimitadas e gestão avançada.</div>
            </div>
          </div>
          <button onClick={() => setShowUpgrade(true)} style={{ padding: "6px 12px", borderRadius: 8, fontSize: 10, fontWeight: 700, fontFamily: MN, cursor: "pointer", background: "rgba(16,185,129,0.055)", color: C.accent, border: `1px solid ${C.accent}30`, whiteSpace: "nowrap" }}>Ver benefícios</button>
        </div>
      )}
