...
export default function SaudeFinanceira({ onBack, user }) {
  ...
  return <div style={{ padding: "24px 28px", maxWidth: 760, margin: "0 auto", fontFamily: FN }}>
    ...
    {data.questionarioCompleto && <div style={{ border: `1px solid ${C.accentBorder}`, background: `${C.accent}10`, color: C.textDim, borderRadius: 14, padding: 12, marginBottom: 14, fontSize: 12 }}>Questionário salvo. Você pode revisar qualquer bloco quando quiser.</div>}
    {conteudo}
  </div>;
}
