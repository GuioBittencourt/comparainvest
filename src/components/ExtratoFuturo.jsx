...
export default function ExtratoFuturo({ data }) {
  ...
  return (
    <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 18, padding: 18, width: "min(1400px, calc(100vw - 32px))", marginLeft: "50%", transform: "translateX(-50%)" }}>
