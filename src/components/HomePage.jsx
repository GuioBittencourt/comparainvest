...
function TrackCard({ title, description, eyebrow, mark, tone = "green", onClick }) {
  const tones = {
    green: {
      color: C.accent,
      bg: "rgba(16,185,129,0.075)",
      border: "rgba(16,185,129,0.28)",
      card: "linear-gradient(135deg, rgba(16,185,129,0.055), rgba(10,18,28,0.96) 54%)",
    },
    blue: {
      color: C.blue,
      bg: "rgba(59,130,246,0.075)",
      border: "rgba(59,130,246,0.30)",
      card: "linear-gradient(135deg, rgba(59,130,246,0.055), rgba(10,18,28,0.96) 54%)",
    },
    amber: {
      color: C.orange,
      bg: "rgba(217,119,6,0.075)",
      border: "rgba(217,119,6,0.30)",
      card: "linear-gradient(135deg, rgba(217,119,6,0.050), rgba(10,18,28,0.96) 54%)",
    },
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontFamily: FN, fontSize: 18, fontWeight: 700, color: C.white, marginBottom: 5 }}>
          {title}
        </div>
      ...
      <span style={{ fontSize: 24, color: t.color, lineHeight: 1, opacity: 0.88 }}>→</span>
    </button>
  );
}
