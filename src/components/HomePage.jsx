  ...
  return (
    <button
      ...
      style={{
        ...
        marginBottom: 16,
        background: active
          ? "linear-gradient(135deg, rgba(0,212,126,0.12), rgba(10,18,28,0.96))"
          : "rgba(10,18,28,0.92)",
        ...
        gap: 18,
        transition: "all 0.2s",
        boxShadow: active ? "0 20px 60px rgba(0,212,126,0.08)" : "0 18px 50px rgba(0,0,0,0.16)",
      }}
    ...
    >
      <div
        style={{
          ...
          background: "rgba(0,212,126,0.075)",
          display: "flex",
          alignItems: "center",
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontFamily: FN, fontSize: 18, fontWeight: 850, color: active ? C.accent : C.white, marginBottom: 5 }}>
          {title}
        </div>
  ...
  return (
    <div style={{ padding: "34px 28px", maxWidth: 760, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 30 }}>
        <div style={{ fontSize: 11, color: C.accent, fontWeight: 800, letterSpacing: 1.4, textTransform: "uppercase", marginBottom: 10 }}>
          comparainvest
        </div>
        <h2 style={{ fontFamily: FN, fontSize: 30, lineHeight: 1.08, fontWeight: 900, color: C.white, margin: "0 0 10px" }}>
          Olá, {user?.nome || "investidor"}.
        </h2>
      ...
      <div
        style={{
          ...cardStyle,
          background: "linear-gradient(135deg, rgba(0,212,126,0.10), rgba(10,18,28,0.96))",
          border: `1px solid ${C.accentBorder}`,
          padding: "24px 22px",
          marginBottom: 20,
        }}
      >
        <div style={{ fontSize: 11, fontWeight: 850, color: C.accent, letterSpacing: "1.2px", textTransform: "uppercase", marginBottom: 10 }}>
          Comece por aqui
        </div>
        <div style={{ fontSize: 18, color: C.white, fontWeight: 850, marginBottom: 10, lineHeight: 1.3 }}>
