...
import { IconAcoes, IconCursos, IconNegocio } from "./Icons" from "../lib/theme";
  ...
  return (
    <div style={{ padding: "32px 28px", maxWidth: 700, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <h2 style={{ fontFamily: TN, fontSize: 24, fontWeight: 400, color: C.white, margin: "0 0 8px" }}>
          Olá, {user?.nome}!
        </h2>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: TN, fontSize: 18, fontWeight: 400, color: C.accent, marginBottom: 4 }}>
            Investimentos
          </div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: TN, fontSize: 18, fontWeight: 400, color: C.text, marginBottom: 4 }}>
            Educação Financeira
          </div>
          <div style={{ fontSize: 13, color: C.textDim, lineHeight: 1.6 }}>
      ...
      <button
        ...
        style={{
          width: "100%", padding: "28px 24px", marginBottom: 24,
          background: "linear-gradient(135deg, #0D1917 0%, #0D1117 100%)",
          border: `1px solid ${C.accentBorder}`, borderRadius: 18,
          cursor: "pointer", textAlign: "left", display: "flex", alignItems: "center", gap: 18,
          transition: "all 0.2s",
        }}
      ...
      >
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 13, color: C.textDim, lineHeight: 1.6 }}>
            DRE simplificado, controle de receitas e despesas, diagnóstico por segmento
          </div>
        </div>
        <span style={{ fontSize: 22, color: C.accent }}>→</span>
      </button>
