"use client";
import { C, MN, FN, heroStyle } from "../../lib/theme";
      ...
      {!analise.vazio && (
        <div style={{
          ...
          <div style={{ padding: 10, borderRadius: 10, background: 'rgba(255,255,255,0.015)', border: `1px solid ${C.border}` }}>
            ...
            <div style={{ fontFamily: MN, fontSize: 16, fontWeight: 700, color: corSeveridade(analise.classes.margem) }}>
          ...
          <div style={{ padding: 10, borderRadius: 10, background: 'rgba(255,255,255,0.015)', border: `1px solid ${C.border}` }}>
            ...
            <div style={{ fontFamily: MN, fontSize: 16, fontWeight: 700, color: analise.totals.lucro >= 0 ? C.accent : C.red }}>
          ...
          <div style={{ padding: 10, borderRadius: 10, background: 'rgba(255,255,255,0.015)', border: `1px solid ${C.border}` }}>
            ...
            <div style={{ fontFamily: MN, fontSize: 16, fontWeight: 700, color: corSeveridade(analise.classes.custo) }}>
