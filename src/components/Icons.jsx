...
export function IconControle({ size = 24 }) {
  return sv(size, <><path d="M4 6H20" /><path d="M4 12H20" /><path d="M4 18H20" /><circle cx="8" cy="6" r="2" /><circle cx="16" cy="12" r="2" /><circle cx="10" cy="18" r="2" /></>) ;
}

export function IconMais({ size = 24 }) {
  return sv(size, <><circle cx="5" cy="12" r="1.5" /><circle cx="12" cy="12" r="1.5" /><circle cx="19" cy="12" r="1.5" /></>) ;
}
