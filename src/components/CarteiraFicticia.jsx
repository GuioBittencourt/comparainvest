...
const CATEGORIES = {
  rf: { label: "Renda Fixa", icon: "", color: "#6EE7B7" },
  fii: { label: "FIIs", icon: "", color: C.accent },
  acoes: { label: "Ações", icon: "", color: "#94A3B8" },
  cripto: { label: "Cripto", icon: "₿", color: "#CBD5E1" },
};
...
const [rfValue, setRfValue] = useState("");
  ...
  return (
    <div>
      ...
      <h2 style={{ fontFamily: TN, fontSize: 20, fontWeight: 400, color: C.white, margin: "0 0 8px" }}>Minha Carteira Fictícia</h2>
