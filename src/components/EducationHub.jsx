...
export default function EducationHub({ onBack, user }) {
  ...
  return (
    <div style={{ padding: "24px 28px", maxWidth: 700, margin: "0 auto" }}>
      ...
      <div style={{ width: "100%", textAlign: "left", background: C.card, border: `1px solid ${C.border}`, borderRadius: 16, padding: "20px 22px", marginBottom: 16, display: "flex", alignItems: "center", gap: 16, opacity: 0.72 }}>
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            <span style={{ fontFamily: TN, fontSize: 16, fontWeight: 400, color: C.white }}>Saúde Financeira</span>
            <span style={{ fontSize: 9, padding: "2px 8px", borderRadius: 4, background: `${C.yellow}15`, color: C.yellow, fontFamily: MN }}>Em breve</span>
          </div>
