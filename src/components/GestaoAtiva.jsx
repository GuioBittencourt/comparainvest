...
export default function GestaoAtiva({ user }) {
  ...
  return (
    <div>
      ...
      <p style={{ textAlign: "center", fontSize: 9, color: C.textMuted, marginTop: 14, lineHeight: 1.5 }}>compara.ai — Gestão Ativa. Gastos resetam todo início de mês.{!isPremium && " Conta gratuita: máx. 2 categorias."}</p>
