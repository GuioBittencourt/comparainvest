...
const PRESETS = [
  ...
  { id: "transporte", label: "Transporte / Gasolina", icon: <IconTransporte size={18} />, color: C.blue },
  { id: "diversao", label: "Diversão / Lazer", icon: <IconDiversao size={18} />, color: C.purple },
  { id: "saude", label: "Saúde / Farmácia", icon: <IconSaude size={18} />, color: C.pink },
  { id: "pets", label: "Pets", icon: <IconPets size={18} />, color: C.yellow },
  { id: "cursos", label: "Cursos e Livros", icon: <IconCursos size={18} />, color: C.petroleum },
  { id: "outros", label: "Outros", icon: <IconOutros size={18} />, color: C.graphite },
];
...
const HEALTHY = [
  ...
  { label: "Invest. Curto Prazo", pct: 15, color: C.yellow, desc: "Reserva emergência, Tesouro Selic, CDB liquidez..." },
  { label: "Estudos / Educação", pct: 5, color: C.petroleum, desc: "Cursos, livros, capacitação profissional..." },
];
...
export default function GestaoAtiva({ user }) {
  ...
  const distData = [{ name: "Fixas", value: fixas, fill: C.blue }, { name: "Variáveis", value: totalSpent, fill: C.purple }, { name: "Disponível", value: Math.max(0, renda - fixas - totalSpent), fill: C.accent }].filter((d) => d.value > 0);
