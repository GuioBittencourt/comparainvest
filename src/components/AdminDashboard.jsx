...
export default function AdminDashboard() {
  ...
  const sexoData = useMemo(() => {
    ...
    return [
      { name: "Masculino", value: c.M, fill: C.accent },
      { name: "Feminino", value: c.F, fill: "#6EE7B7" },
      { name: "Outro", value: c.O, fill: "#94A3B8" },
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
        <div>
          <h2 style={{ fontFamily: TN, fontSize: 20, fontWeight: 400, color: C.white, margin: 0 }}>Painel Administrativo</h2>
