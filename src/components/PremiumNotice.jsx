...
const COPY = {
  comparador: {
    tag: "PREMIUM",
    title: "Mais comparações, mais clareza.",
    desc: "Desbloqueie comparações ilimitadas e análises mais completas.",
  },
  rendaFixa: {
    tag: "PREMIUM",
    title: "Toda renda fixa, lado a lado.",
    desc: "Compare títulos, prazos e cenários sem travas.",
  },
  gestaoAtiva: {
    tag: "PREMIUM",
    title: "Gestão completa do seu mês.",
    desc: "Categorias ilimitadas, diagnóstico e relatórios completos.",
  },
  meuNegocio: {
    tag: "PREMIUM",
    title: "Diagnóstico cruzado dos seus negócios.",
    desc: "Benchmark, ações recomendadas e leitura executiva.",
  },
  carteira: {
    tag: "PREMIUM",
    title: "Carteira sem teto.",
    desc: "Simule mais ativos e veja sua estratégia completa.",
  },
  saudeFinanceira: {
    tag: "PREMIUM",
    title: "Extrato futuro e relatório completo.",
    desc: "Transforme seu mapa financeiro em plano de ação.",
  },
  default: {
    tag: "PREMIUM",
    title: "Desbloqueie a visão completa.",
    desc: "Acesse recursos avançados do comparainvest.",
  },
};
  ...
  return (
    <button
      ...
      style={{
        ...
        background: "linear-gradient(135deg, rgba(8,27,51,0.96) 0%, rgba(6,16,25,0.98) 68%, rgba(12,24,37,0.96) 100%)",
        borderRadius: 20,
        padding: "14px 15px",
        marginBottom: 14,
        display: "flex",
